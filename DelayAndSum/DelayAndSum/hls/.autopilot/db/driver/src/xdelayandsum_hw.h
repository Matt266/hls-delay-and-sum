...
#define XDELAYANDSUM_CONTROL_ADDR_AXIS_PACKET_SIZE_DATA 0x10
#define XDELAYANDSUM_CONTROL_BITS_AXIS_PACKET_SIZE_DATA 26
#define XDELAYANDSUM_CONTROL_ADDR_PHI_DATA              0x18
#define XDELAYANDSUM_CONTROL_BITS_PHI_DATA              8
#define XDELAYANDSUM_CONTROL_ADDR_FC_DATA               0x20
#define XDELAYANDSUM_CONTROL_BITS_FC_DATA               32
#define XDELAYANDSUM_CONTROL_ADDR_XPOS1_DATA            0x28
#define XDELAYANDSUM_CONTROL_BITS_XPOS1_DATA            32
#define XDELAYANDSUM_CONTROL_ADDR_XPOS2_DATA            0x30
#define XDELAYANDSUM_CONTROL_BITS_XPOS2_DATA            32
#define XDELAYANDSUM_CONTROL_ADDR_XPOS3_DATA            0x38
#define XDELAYANDSUM_CONTROL_BITS_XPOS3_DATA            32
#define XDELAYANDSUM_CONTROL_ADDR_XPOS4_DATA            0x40
