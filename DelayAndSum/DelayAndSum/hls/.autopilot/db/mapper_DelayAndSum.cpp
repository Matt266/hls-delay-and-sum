...
auto* sout_imag_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_imag_V_last_V);
  // DUT call
  DelayAndSum(__xlx_apatb_param_axis_packet_size, __xlx_apatb_param_phi, __xlx_apatb_param_fc, __xlx_apatb_param_xpos1, __xlx_apatb_param_xpos2, __xlx_apatb_param_xpos3, __xlx_apatb_param_xpos4, sin1_real->data<short>(), sin1_imag->data<short>(), sin2_real->data<short>(), sin2_imag->data<short>(), sin3_real->data<short>(), sin3_imag->data<short>(), sin4_real->data<short>(), sin4_imag->data<short>(), sout_real_V_data_V->data<short>(), sout_real_V_last_V->data<char>(), sout_imag_V_data_V->data<short>(), sout_imag_V_last_V->data<char>());
