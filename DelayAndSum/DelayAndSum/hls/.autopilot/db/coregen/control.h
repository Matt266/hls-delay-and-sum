...
#define CONTROL_ADDR_AXIS_PACKET_SIZE_DATA 0x10
#define CONTROL_BITS_AXIS_PACKET_SIZE_DATA 26
#define CONTROL_ADDR_PHI_DATA              0x18
#define CONTROL_BITS_PHI_DATA              8
#define CONTROL_ADDR_FC_DATA               0x20
#define CONTROL_BITS_FC_DATA               32
#define CONTROL_ADDR_XPOS1_DATA            0x28
#define CONTROL_BITS_XPOS1_DATA            32
#define CONTROL_ADDR_XPOS2_DATA            0x30
#define CONTROL_BITS_XPOS2_DATA            32
#define CONTROL_ADDR_XPOS3_DATA            0x38
#define CONTROL_BITS_XPOS3_DATA            32
#define CONTROL_ADDR_XPOS4_DATA            0x40
