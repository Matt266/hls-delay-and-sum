...
if {[file isfile DelayAndSum.autotvin.dat]} {
	file delete -force DelayAndSum.autotvin.dat
}

if {[file isfile DelayAndSum.autotvout.dat]} {
	file delete -force DelayAndSum.autotvout.dat
}
