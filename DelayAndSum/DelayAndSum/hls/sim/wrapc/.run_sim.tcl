...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DelayAndSum.autotvin.dat"
	set constFileTvOut       "DelayAndSum.autotvout.dat"
	set constFileHdlTvIn     "DelayAndSum.autohdltvin.dat"
	set constFileHdlTvOut    "DelayAndSum.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
