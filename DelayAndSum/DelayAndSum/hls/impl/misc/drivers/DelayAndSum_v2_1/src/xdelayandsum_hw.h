...
#define XDELAYANDSUM_CONTROL_BITS_PHI_DATA              20
...
#define XDELAYANDSUM_CONTROL_ADDR_INVERT_CHANNEL_DATA   0x4c
#define XDELAYANDSUM_CONTROL_BITS_INVERT_CHANNEL_DATA   10
